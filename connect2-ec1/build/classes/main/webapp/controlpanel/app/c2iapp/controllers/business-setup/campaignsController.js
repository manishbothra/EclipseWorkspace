...
define(['app'], function (app) {
    ...
    var campaignsController = function ($scope, $location, $routeParams, authService, dataService, $rootScope, modalService,$filter) {
        $scope.productForm = {};
    ...
    campaignsController.$inject = injectParams;
    app.register.controller('campaignsController', campaignsController);
