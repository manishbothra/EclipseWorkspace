...
define(['app'], function (app) {
    ...
    var financesController = function ($scope, $location, $routeParams, authService, dataService, $rootScope, modalService,$filter) {
        $scope.productForm = {};
    ...
    financesController.$inject = injectParams;
    app.register.controller('financesController', financesController);
