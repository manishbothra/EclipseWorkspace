 ...
 */
package com.connect2.ec.adapter.ec.am.orders.samples;

import com.connect2.ec.adapter.ec.am.bean.CredentialsBean;
import com.connect2.ec.adapter.ec.am.orders.services.MarketplaceWebServiceOrdersAsyncClient;
import com.connect2.ec.adapter.ec.am.orders.services.MarketplaceWebServiceOrdersClient;
import com.connect2.ec.adapter.ec.am.orders.services.MarketplaceWebServiceOrdersConfig;
...
public class MarketplaceWebServiceOrdersSampleConfig {
    ...
    private static String accessKey = "replaceWithAccessKey";

    /** Developer AWS secret key. */
    private static String secretKey = "replaceWithSecretKey";

    /** The client application name. */
    private static String appName = "replaceWithAppName";
     ...
     */
    private static String serviceURL = "replaceWithServiceURL";
     ...
     */
    public static MarketplaceWebServiceOrdersClient getClient(CredentialsBean credentials) {
