 ...
 */
package com.connect2.ec.adapter.ec.am.fulfillmentinventory.mock;
...
import com.connect2.ec.adapter.ec.am.client.MwsXmlReader;
import com.connect2.ec.adapter.ec.am.fulfillmentinventory.*;
import com.connect2.ec.adapter.ec.am.fulfillmentinventory.model.GetServiceStatusRequest;
import com.connect2.ec.adapter.ec.am.fulfillmentinventory.model.GetServiceStatusResponse;
import com.connect2.ec.adapter.ec.am.fulfillmentinventory.model.ListInventorySupplyByNextTokenRequest;
import com.connect2.ec.adapter.ec.am.fulfillmentinventory.model.ListInventorySupplyByNextTokenResponse;
    ...
    private <T extends MwsObject> T newResponse(
        ...
        try {
            ...
            ResponseHeaderMetadata rhmd = new ResponseHeaderMetadata(
                "mockRequestId", Arrays.asList("A","B","C"), "mockTimestamp", 0d, 0d, (java.sql.Date) new Date());
