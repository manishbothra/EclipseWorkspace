...
package com.connect2.ec.adapter.ec.eb.accessToken.api.security.openid.jwt;
        ...
        if (locked.compareAndSet(false, true)) {
            ...
            if (response.isSuccessful()) {
                ...
                for (Object key : jsonObject.keySet()) {
                    String certStr = jsonObject.get((String) key).toString();
                    ...
                    CERT_HOLDER_MAP.put((String) key, x509Cert);
