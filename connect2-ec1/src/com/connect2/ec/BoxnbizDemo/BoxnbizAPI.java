...
public class BoxnbizAPI {
	...
	static void inquiry_update_inquiry() throws Exception{
		...
		json.put("destination_handling", "Y");
		json.put("destination_cha", "Y");
		json.put("gross_weight", 45678);
		json.put("gross_weight_unit", "KG");
		json.put("commodity", "Machine");
		json.put("cargo_type", "Non-HAZ");
		json.put("expected_pickup_Date", "28/09/2020");
		json.put("lcl_package_quantity", 0);
		json.put("lcl_package_type", "Null");
		json.put("fcl_container_quantity", 8);
		json.put("fcl_container_type", "Reefer");
		json.put("fcl_container_size", "40");
		json.put("fcl_container_stuffing", "CFS Stuffing");
		...
		json.put("special_instruction", "Last instant inquiry updated");
		//System.out.println(json);
		
		StringEntity entity=new StringEntity(json.toString(),  "UTF-8");
		String inquiry_id="RFQ000738";
	...
	static void find_instant_rate() throws Exception{
        ...
        while ((line=in.readLine())!=null){
        	System.out.println(line);
        	JSONArray j1=new JSONArray(line);
     
        	Object s=j1.getJSONObject(0).get("instant_id");
        	int s1=j1.getJSONObject(0).getInt("instant_id");
        }
	}
	static void inquiry_check_inquiry_status() throws Exception{
		String inquiry_id="RFQ000726";
		String company_id="ICONN660";
        ...
        while ((line=in.readLine())!=null){
        	...
        	if(j.has("success")) {
        		String st=j.getString("success");
        		String stt[]=st.split(" - ");
        		System.out.println(stt[1]);
        	}
        }
	}
	static String inquiry_close() throws Exception{
		String inquiry_id="RFQ000726";
		String company_id="ICONN660";
		String reason="hello";
		try
	...
	static void booking_book_quotation() throws Exception{
		String inquiry_id="INS206696";
		String company_id="ICONN660";
		String quotation_id="null";
		int instant_id=5876;
		String url="https://demo.api.boxnbiz.com/v1/booking/book-quotation?inquiryId="+inquiry_id+"&company_id="+company_id+"&quotationId="+quotation_id+"&instant_id="+instant_id;
		System.out.println(url);
		HttpPost httppost=new HttpPost(url);
		httppost.addHeader("Authorization", "Bearer eyJhbGciOiJIUzI1NiJ9..YxU3M21SHLivKqJ-JD8ktfr6pReFhNVE-LLCmbH3aJs");
		//httppost.addHeader("message",null);
